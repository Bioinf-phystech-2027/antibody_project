...
Из полученных гистограм мы сошлись на том, что 1, 2 и 4 аминокислоты в CDR1 и 1 аминокислота в CDR2 строго консервативны, что вдальнейшем подтверждается.
...
7. Получены и проанализированы частотные профили по нуклеотидам:
